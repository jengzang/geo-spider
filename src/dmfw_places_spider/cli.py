...
from dmfw_places_spider.services.dmfw import DmfwRunOptions, run_dmfw_chars_pipeline, run_dmfw_parallel_tasks, sync_dmfw_divisions
from dmfw_places_spider.storage.sqlite import SQLiteRegionRepository
from dmfw_places_spider.utils.logging import setup_logging
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="dmfw-places", description="Administrative division spider scaffold.")
